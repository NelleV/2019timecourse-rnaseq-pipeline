...
time = c(0, 3, 6, 9, 12, 18, 24, 30, 48, 60, 72, 120, 168)
...
timely_barplot(M_weekly_de_analysis, time, title="California")
timely_barplot(VH_weekly_de_analysis, time, title="Vietnam high")
timely_barplot(weekly_de_analysis, time, title="Vietnam low")
```

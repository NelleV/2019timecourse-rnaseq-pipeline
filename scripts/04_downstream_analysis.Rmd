...
```{r enrichment_analysis, results="hide", message=FALSE, eval=FALSE}
...
```{r echo=FALSE}
all_pathways = read.table("results/all_pathways.tsv",
			  sep="\t")
```
...
```{r go_term_enrichment, results="hide", message=FALSE, eval=FALSE}
...
```{r echo=FALSE}
all_go_terms = read.table(
    "results/all_go_terms.tsv",
    sep="\t")
```

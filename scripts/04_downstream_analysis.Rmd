...
```{r go_to_gene_mapping, results="hide"}

genes = getBM(attributes=c("go_id", "refseq_mrna"), values=gene_names, filters="refseq_mrna",
	      mart=ensembl)
...
for(gene in gene_names){
    go_terms = genes[genes[, "refseq_mrna"] == gene, "go_id"]
...
```{r go_term_enrichment, results="hide"}
...
all_go_terms = all_go_terms[
    order(all_go_terms["Cluster",],
	  all_go_terms["resultFisher.p.adj",])]

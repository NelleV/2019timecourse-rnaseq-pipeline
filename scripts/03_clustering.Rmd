...
for(n_cluster in all_possible_n_clusters){
    ...
    all_clustering[i] = clustering_results
    i = i + 1
}
```
...
average_silhoutte = function(labels, y) {
...
for(i in 1:length(all_clustering)){
    ...
    average_silhoutte_values[i] = average_silhoutte(labels, y)
    i = i + 1
}

plot(all_possible_n_clusters, average_silhoutte_values,
     type="b", pch=19, frame=FALSE,
     xlab="Number of clusters K",

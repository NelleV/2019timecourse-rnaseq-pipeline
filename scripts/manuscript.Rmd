...
First let's load the data. We provide the normalized
data and metadata of [@shoemaker:ultrasensitive] for simplicity.

```{r}
# Now load in the metadata
meta = read.table("../data/shoemaker2015/meta.tsv")
data = read.table(gzfile("../data/shoemaker2015/data.tsv.gz"))
```

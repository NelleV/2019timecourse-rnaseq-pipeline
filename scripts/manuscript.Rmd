...
kmeans_clusters = splines_kmeans(
    moanin_model[genes_to_keep, ], n_clusters=8,
    random_seed=42,
    n_init=20)
```
...
**EAP** actually, why do we need to rescale them between 0-1 rather than just a normal call to `scale`? Would it really make a difference?

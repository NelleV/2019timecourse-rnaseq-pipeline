...
While we showcase this pipeline on micro-array data, [@varoquaux:lifetime]
...
kable(go_terms_enriched[1:15, ], format="latex", escape=F, digits=4, booktabs=TRUE)
```

...
abstract: >
    ...
    influenza, ihis workflows provides a step-by-step tutorial of the
...
```{r schema, echo=FALSE, fig.width=8, fig.cap="Workflow for analyzing time-course datasets."}
...
```{r reading_targets, results="hide", fig.width=8, fig.height=4, message=FALSE, warning=FALSE}

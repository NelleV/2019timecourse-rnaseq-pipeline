...
dataToPlot = rbind([cluster2Score[1:4], ],
    "Centroid"=kmeans_clusters$centroids[cluster_of_interest, ])
...
res = aheatmap(
    assay(de_moanin_model[genes_to_plot,ord]),
    Colv=NA,
    color="YlGnBu",
    annCol=submeta[,
                c("Group", "Timepoint")],
...
aheatmap(
    rescale_values(de_moanin_model[genes_to_plot,ord])[res$rowInd,],
    Colv=NA,
    Rowv=NA,
    annCol=submeta[,
                c("Group", "Timepoint")],
...
for(n_cluster in all_possible_n_clusters){
    clustering_results = splines_kmeans(y,
...
kmeans_clusters = splines_kmeans(y[indices,]

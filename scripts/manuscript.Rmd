...
**Nelle: This is currently for debugging purposes. The distribution of scores
seems very strange to me, with a lot of genes that don't match at all to any
clusters.**

```{r visualize_scores_all_figure, fig.height=6, fix.width=6}
# Get the best score for each gene
scores = apply(scores_and_labels$scores, 1, min)
hist(scores, breaks=(1:50/50)            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            ...
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
            188745       low 6-RSEC.s singlece  R    9:50:32      1 scf-sm11
, col="black", main="Distribution of scores")
```

**Compared to the EPICON project, a lot of genes seem to have very very poor
scores. The threshod on the EPICON project on the score was around 0.55, while
here, it is close to 0.87. The scores range from 0 to 1, with 1 being no
correlation between the gene and the centroid.**

```{r visualize_scores, fig.height=6, fix.width=6}
# Get the best score for each gene
par(mfrow=c(4, 5))
scores = apply(scores_and_labels$scores, 1, min)

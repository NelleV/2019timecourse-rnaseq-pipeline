...
- Do we need installation instructions for moanin in this document, since its
  ...
  `install_github` from `devtools`. If able to call
  `install_github("NelleV/2019timecourse-rnaseq-pipeline",
  subdir="bin/moanin", dependencies=TRUE)` would be simpler (would also

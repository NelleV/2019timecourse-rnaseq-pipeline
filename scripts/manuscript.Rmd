...
plot_splines_data(data[exampleGenes,], splines_model, colors=ann_colors$Group)
``` 

**EAP: It would be nice to be able to subset in `plot_splines_data/plot_splines_data` to only some of the groups**

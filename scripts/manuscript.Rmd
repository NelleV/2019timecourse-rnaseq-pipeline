...
- I got an error in installation of packages:
...
- `biocLite` is no longer the recommended way to install bioconductor. Instead `BiocManager::install(c('edge', 'NMI'))`. But this is dependent on bioconductor/R version. 

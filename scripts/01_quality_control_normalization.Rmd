...
par(mfrow=c(1, 2))
autoplot(pca_data, data=meta, colour="Group", shape="Replicate") +
    scale_color_manual(values=as.vector(unlist(ann_colors["Group"])))

autoplot(pca_data, data=meta, colour="Time", shape="Replicate") +
    scale_color_manual(values=as.vector(unlist(ann_colors["Time"])))
```

...
We can already see interesting patterns: the cross-correlation amongst samples
taking from the untreated mice is higher than the cross correlation amongst

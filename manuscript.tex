...
The manuscript was last compile on 2020-06-09 10:34:59.
...
{\centering \includegraphics[width=11.53in]{images/fig1_schemas} 
...
{\centering \includegraphics{reports/manuscript_files/figure-latex/geneVarHist-1} 
...
\textbf{EAP}: Not sure why you hide the code for this plot, but not for others\ldots{}
...
\begin{center}\includegraphics{reports/manuscript_files/figure-latex/pcaPlots-1} \end{center}
...
{\centering \includegraphics{reports/manuscript_files/figure-latex/correlationPlot-1} 

}

\caption{Cross-correlation of the samples}\label{fig:correlationPlot}
\end{figure}
...
{\centering \includegraphics{reports/manuscript_files/figure-latex/unnamed-chunk-14-1} 

}

\caption{Distribution of DE genes per condition}\label{fig:unnamed-chunk-14}
\end{figure}
...
{\centering \includegraphics{reports/manuscript_files/figure-latex/unnamed-chunk-25-1} 

}

\caption{Confusion matrix between the two sets of labels}\label{fig:unnamed-chunk-25}
\end{figure}
...
\begin{center}\includegraphics{reports/manuscript_files/figure-latex/unnamed-chunk-34-2} \end{center}

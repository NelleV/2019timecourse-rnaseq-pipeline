...
samples in scatter plots. We also reorder the factor \texttt{Group} which describes
...
\hypertarget{looking-at-specific-clusters-in-detail.}{%
\subsubsection{Looking at specific clusters in detail.}\label{looking-at-specific-clusters-in-detail.}}

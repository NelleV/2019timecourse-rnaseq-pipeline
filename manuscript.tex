...
\KeywordTok{install_github}\NormalTok{(}\StringTok{"NelleV/moanin"}\NormalTok{, dependencies)}
...
\textbf{EAP: It would be nice to be able to subset in \texttt{plot\_splines\_data/plot\_splines\_data} to only some of the groups}
...
\KeywordTok{plot_splines_data}\NormalTok{(data[top_DE_genes_pval, ], splines_model,}
...
\KeywordTok{plot_splines_data}\NormalTok{(data[top_DE_genes_lfc, ], splines_model,}
    \DataTypeTok{colors=}\NormalTok{ann_colors}\OperatorTok{$}\NormalTok{Group, }\DataTypeTok{smooth=}\OtherTok{TRUE}\NormalTok{,}
    \DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\FloatTok{1.5}\NormalTok{,}\FloatTok{2.5}\NormalTok{,}\DecValTok{2}\NormalTok{,}\FloatTok{0.1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    kmeans_clusters}\OperatorTok{$}\NormalTok{centroids, splines_model,}

...
The manuscript was last compile on 2020-07-27 18:04:28.
...
{\centering \includegraphics[width=.5\textwidth,]{reports/manuscript_files/figure-latex/unnamed-chunk-18-1} 
...
\NormalTok{dataToPlot =}\StringTok{ }\KeywordTok{rbind}\NormalTok{(}
    \KeywordTok{assay}\NormalTok{(moanin_model[cluster2Score[}\DecValTok{1}\OperatorTok{:}\DecValTok{4}\NormalTok{], ]),}
    \StringTok{"Centroid"}\NormalTok{=kmeans_clusters}\OperatorTok{$}\NormalTok{centroids[cluster_of_interest, ])}
\KeywordTok{plot_splines_data}\NormalTok{(}
\NormalTok{    moanin_model, }\DataTypeTok{data=}\NormalTok{dataToPlot, }
    \DataTypeTok{colors=}\NormalTok{ann_colors}\OperatorTok{$}\NormalTok{Group, }\DataTypeTok{smooth=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{simpleY=}\OtherTok{FALSE}\NormalTok{,}
    \DataTypeTok{mar=}\KeywordTok{c}\NormalTok{(}\FloatTok{1.5}\NormalTok{, }\FloatTok{2.5}\NormalTok{, }\DecValTok{2}\NormalTok{, }\FloatTok{0.1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\midrule
GO:0019395 & fatty acid oxidation & 55 & 54 & 44.78 & 0.00016 & 0.164\\
GO:1905114 & cell surface receptor signaling pathway ... & 272 & 243 & 221.46 & 0.00021 & 0.179\\
GO:0003002 & regionalization & 174 & 158 & 141.67 & 0.00049 & 0.358\\
GO:0009755 & hormone-mediated signaling pathway & 82 & 77 & 66.76 & 0.00105 & 0.671\\
...
GO:0090596 & sensory organ morphogenesis & 138 & 124 & 112.36 & 0.00332 & 1.000\\
GO:0035108 & limb morphogenesis & 74 & 69 & 60.25 & 0.00337 & 1.000\\
GO:0030166 & proteoglycan biosynthetic process & 27 & 27 & 21.98 & 0.00385 & 1.000\\
GO:0003206 & cardiac chamber morphogenesis & 72 & 67 & 58.62 & 0.00448 & 1.000\\
\addlinespace
GO:0055114 & oxidation-reduction process & 536 & 472 & 436.41 & 0.00489 & 1.000\\
GO:0021954 & central nervous system neuron developmen... & 36 & 35 & 29.31 & 0.00557 & 1.000\\
GO:0006261 & DNA-dependent DNA replication & 70 & 64 & 56.99 & 0.00595 & 1.000\\
GO:0006633 & fatty acid biosynthetic process & 78 & 70 & 63.51 & 0.00686 & 1.000\\
GO:0006790 & sulfur compound metabolic process & 154 & 136 & 125.39 & 0.00710 & 1.000\\
\bottomrule
\end{tabular}
